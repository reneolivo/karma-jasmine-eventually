(function() {
  ...
  function JasmineEventually(files) {
    ...
    /**
     * @description
     * Locate the Jasmine Eventually library.
     *
     * @return {String}
     */
    function getLibPath() {
      return require.resolve('jasmine_eventually');
    }
    ...
    if (ix !== -1) {
      ...
      throw new Error('"jasmine" needs to appear before "jasmine-eventually" in the "frameworks" array of your Karma configuration.');
    }

  }

  JasmineEventually.$inject = ['config.files'];

  module.exports = {
    'framework:jasmine-eventually': ['factory', JasmineEventually]
  };
